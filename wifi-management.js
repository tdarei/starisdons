...
class WiFiManagement {
    ...
    init() {
        this.trackEvent('w_if_im_an_ag_em_en_t_initialized');
    }

    trackEvent(eventName, data = {}) {
        try {
            if (typeof window !== 'undefined' && window.performanceMonitoring) {
                window.performanceMonitoring.recordMetric("w_if_im_an_ag_em_en_t_" + eventName, 1, data);
            }
        } catch (e) { /* Silent fail */ }
    }
...
if (typeof window !== 'undefined') {
    window.wifiManagement = new WiFiManagement();
}
if (typeof module !== 'undefined' && module.exports) {
    module.exports = WiFiManagement;
}
