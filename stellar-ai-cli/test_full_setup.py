...
def check_google_api():
    ...
    if api_key:
        ...
        print("  Set it with: export GOOGLE_API_KEY='your-api-key' (Linux/Mac)")
        print("  Or: $env:GOOGLE_API_KEY='your-api-key' (PowerShell)")
        return False
...
def main():
    ...
    if all(results.values()):
        ...
        if not results['livekit']:
            print("\nRun setup_env.ps1 (Windows) or setup_env.sh (Linux/Mac) to set LiveKit environment variables")
