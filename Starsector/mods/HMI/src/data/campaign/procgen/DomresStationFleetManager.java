...
public class DomresStationFleetManager extends SourceBasedFleetManager {

	protected int minPts;
	protected int maxPts;
	protected int totalLost;

	public DomresStationFleetManager(SectorEntityToken source, float thresholdLY, int minFleets, int maxFleets, float respawnDelay,
	...
	protected CampaignFleetAPI spawnFleet() {
		...
		if (combatPoints > 20) type = FleetTypes.PATROL_MEDIUM;
		if (combatPoints > 30) type = FleetTypes.PATROL_LARGE;
