...
): data.scripts.campaign.intel.baseNikoEventStage(intel) {
}
...
@Deprecated("doesnt work on current SS version. remove after 3.0.2")
abstract class data.scripts.campaign.intel.baseNikoEventStage(
     ...
     */
    @Contract("_ -> this")
    open fun init(): data.scripts.campaign.intel.baseNikoEventStage {
        //addSelfToIntel()
        return this
    }
