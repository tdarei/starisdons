...
class ShipDesigner {
    ...
    registerModules() {
        ...
        this.addModule(new ShipModule('hull_dreadnought', 'Dreadnought Hull', 'hull', { hp: 3000, speed: 0.8, capacity: 20 }, { alloys: 2500, circuits: 300 }, 'Flying fortress.'));
...
class ShipRenderer {
    ...
    render(design) {
        ...
        let scale = 1.0;
        if (design.hull.id.includes('battleship')) scale = 0.6;
        if (design.hull.id.includes('cruiser')) scale = 0.75;
