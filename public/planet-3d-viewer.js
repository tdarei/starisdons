...
class Planet3DViewer {
    ...
    createModal() {
        ...
        // Check for VR support (Delegated to ExoplanetXRExperience)
        // logic moved to exoplanet-xr-experience.js
    ...
    generateProceduralTexture(type, baseColor, data) {
        ...
        if (type.includes('gas') || type.includes('giant')) {
            ...
            for (let i = 0; i < 7; i++) {
                ...
                const cy = Math.random() * 800 + 112; // Avoid polar poles slightly
            ...
            ctx.fillRect(0, 0, 2048, 120); // North
            ctx.fillRect(0, 904, 2048, 120); // South
